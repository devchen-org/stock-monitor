...
终端显示：
- 代码、名称、涨跌、涨跌幅、最高价、最低价、现价、成本价、持仓、市值、盈亏额、盈亏率
- 总持仓市值和总盈亏汇总
...
| 代码         | 名称           | 涨跌     | 涨跌幅   | 最高价   | 最低价   | 现价     | 成本价   | 持仓       | 市值           | 盈亏额         | 盈亏率       |
+--------------+----------------+----------+----------+----------+----------+----------+----------+------------+----------------+----------------+--------------+
| sh600519     | 贵州茅台       | +5.00    | +1.20%   | 1800.00  | 1780.00  | 1795.00  | 1780.00  | 100        | 179,500.00     | +1,500.00      | 0.84%        |
| sh601318     | 中国平安       | -0.50    | -1.00%   | 50.50    | 49.50    | 49.50    | 50.00    | 200        | 9,900.00       | -100.00        | -1.00%       |
+--------------+----------------+----------+----------+----------+----------+----------+----------+------------+----------------+----------------+--------------+
|              |                |          |          |          |          |          |          | 总计 (2只) |                | +1,400.00      | 0.76%        |
+--------------+----------------+----------+----------+----------+----------+----------+----------+------------+----------------+----------------+--------------+
